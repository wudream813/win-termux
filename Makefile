...
SRC = src/config.c src/cliphtml.c src/framediff.c src/input.c src/keymap.c src/loghist.c src/main.c src/pane.c src/render.c src/screen.c src/split.c src/theme.c src/utf8.c src/vt.c
TARGET = termux.exe
