// termux.cpp - Windows Terminal Multiplexer v1.0.3
// ---------------------------------------------------------------------------
// v8.3 changes:
...
static const char *const g_help_lines[] = {
    ...
    "\x1b[38;2;139;148;158m  版本 v1.0.3 | Windows Terminal Multiplexer (Win10 1809+)\x1b[0m",
    "",
...
int main(void) {
    ...
    host_printf("\x1b[36;1m Windows Terminal Multiplexer v1.0.3\x1b[0m\r\n");
