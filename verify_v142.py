...
def test_source_code_checks():
    ...
    print("\n=== 5) 验证版本号一致性 (Version consistency v1.4.2) ===")
    assert "// termux.cpp - Windows Terminal Multiplexer v1.4.2" in src, "Header version not v1.4.2"
    assert "版本 v1.4.2 | Windows Terminal Multiplexer" in src, "Help version not v1.4.2"
    assert "■ 版本号 (Version)      :\\x1b[0m \\x1b[38;2;230;237;243;1mv1.4.2\\x1b[0m" in src, "About version not v1.4.2"
    print("  [OK] 源代码版本号全部更新为 v1.4.2")
